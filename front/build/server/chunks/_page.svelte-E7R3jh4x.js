import { c as create_ssr_component, a as add_attribute, v as validate_component, b as add_styles, d as each, e as escape } from './ssr-8OMWU1VZ.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}${add_attribute("value", newPerson.short_description, 0)}></td> <td><input class="svelte-1316pci"${add_attribute("value", newPerson.gender, 0)}></td> <td><input class="svelte-1316pci"${add_attribute("value", newPerson.country, 0)}></td></tr></tbody> <thead data-svelte-h="svelte-1w7yoi0"><tr><th>Profesión</th> <th>Año de nacimiento</th> <th>Año de fallecimiento</th> <th>Edad de muerte</th></tr></thead> <tbody><td><input class="svelte-1316pci"${add_attribute("value", newPerson.occupation, 0)}></td> <td><input type="number" class="svelte-1316pci"${add_attribute("value", newPerson.birth_year, 0)}></td> <td><input type="number" class="svelte-1316pci"${add_attribute("value", newPerson.death_year, 0)}></td> <td><input type="number" class="svelte-1316pci"${add_attribute("value", newPerson.age_of_death, 0)}></td> <td>${validate_component(Button, "Button").$$render($$result, { color: "primary" }, {}, {
    default: () => {
      return `Crear`;
    }
...
//# sourceMappingURL=_page.svelte-E7R3jh4x.js.map
